...
{
    public class AppleSignInService: NSObject, IAppleManager,IASAuthorizationControllerDelegate, IASAuthorizationControllerPresentationContextProviding
    {
